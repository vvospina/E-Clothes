/**
 * Lista presentacional de prendas publicadas.
 */
export default function PrendaList({ items, onEdit, onDelete }) {
  if (items.length === 0) {
    return <p className="text-muted mb-0">No hay prendas registradas todavía.</p>;
  }
        ...
        <article key={item.id} className="list-group-item px-0 py-3">
          <div className="d-flex justify-content-between gap-3 flex-wrap">
            <div>
              ...
              <p className="mb-1">
                Cantidad: {item.cantidad} · Categoría: {item.categoria}
              </p>
            </div>
